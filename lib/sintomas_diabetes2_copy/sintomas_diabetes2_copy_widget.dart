...
import 'sintomas_diabetes2_copy_model.dart';
export 'sintomas_diabetes2_copy_model.dart';

class SintomasDiabetes2CopyWidget extends StatefulWidget {
  const SintomasDiabetes2CopyWidget({super.key});

  static String routeName = 'Sintomas_diabetes2Copy';
  static String routePath = '/sintomasDiabetes2Copy';

  @override
  State<SintomasDiabetes2CopyWidget> createState() =>
      _SintomasDiabetes2CopyWidgetState();
}

class _SintomasDiabetes2CopyWidgetState
    extends State<SintomasDiabetes2CopyWidget> {
  late SintomasDiabetes2CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SintomasDiabetes2CopyModel());
                  ...
                  child: Column(
                    ...
                    children: [
                      Align(
                        alignment: AlignmentDirectional(0.0, 0.0),
                        child: Text(
                          ' Discover the signs of diabetes and how they vary according to the type.',
                      ...
                      Text(
                        'Knowing the symptoms is the first step for early diagnosis.',

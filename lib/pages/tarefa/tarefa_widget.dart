...
export 'tarefa_model.dart';

class TarefaWidget extends StatefulWidget {
  const TarefaWidget({super.key});

  static String routeName = 'Tarefa';
  static String routePath = '/tarefa';
...
class _TarefaWidgetState extends State<TarefaWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TarefaModel());
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          'Em uma escala de 1 a 3 como você se sente hoje?',
                          style:

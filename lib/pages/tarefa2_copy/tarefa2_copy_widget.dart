...
import 'tarefa2_copy_model.dart';
export 'tarefa2_copy_model.dart';

class Tarefa2CopyWidget extends StatefulWidget {
  const Tarefa2CopyWidget({super.key});

  static String routeName = 'Tarefa2Copy';
  static String routePath = '/tarefa2Copy';

  @override
  State<Tarefa2CopyWidget> createState() => _Tarefa2CopyWidgetState();
}

class _Tarefa2CopyWidgetState extends State<Tarefa2CopyWidget> {
  late Tarefa2CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Tarefa2CopyModel());
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          'Mark the actions you performed today',
                          style:
                              ...
                              Material(
                                ...
                                child: Theme(
                                  ...
                                  child: CheckboxListTile(
                                    ...
                                    title: Text(
                                      'Practiced physical activity (or Exercised)',
                                      style: FlutterFlowTheme.of(context)
                                          .titleLarge
                                          .override(
                                            font: GoogleFonts.outfit(
